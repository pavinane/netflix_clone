    ...
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      ...
      >
        <img
          ...
          alt="thambnail"
        />
        <div className=" bg-zinc-800 z-10 p-2 lg:p-4 absolute w-full transition shadow-xl rounded-b-md">
            <div className="flex flex-row items-center gap-3">
                ...
                <BsChevronDown className=" text-white group-hover/item:text-neutral-300" size={15}/>
                </div>
            </div>
